...
internal enum FontFamily {
  ...
  internal enum RobotoCondensed {
    ...
    internal static let boldItalic = FontConvertible(name: "RobotoCondensed-BoldItalic", family: "Roboto Condensed", path: "RobotoCondensed-BoldItalic.ttf")
    internal static let italic = FontConvertible(name: "RobotoCondensed-Italic", family: "Roboto Condensed", path: "RobotoCondensed-Italic.ttf")
    ...
    internal static let lightItalic = FontConvertible(name: "RobotoCondensed-LightItalic", family: "Roboto Condensed", path: "RobotoCondensed-LightItalic.ttf")
    ...
    internal static let all: [FontConvertible] = [bold, boldItalic, italic, light, lightItalic, regular]
  }
  internal static let allCustomFonts: [FontConvertible] = [Roboto.all, RobotoCondensed.all].flatMap { $0 }
